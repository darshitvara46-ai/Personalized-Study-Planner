...
if (downloadBtn) {
    downloadBtn.addEventListener('click', () => {
        ...
        doc.text("Weekly Study Timetable", pageWidth / 2, 25, {
            align: "center"
        });
        ...
        days.forEach(day => {
            ...
            const entries = scheduleEntries.filter(item => item.day === day);
        ...
        doc.text(
            "Generated by Personalized Study Planner",
            pageWidth / 2,
            pageHeight - 10,
            { align: "center" }
        );
        ...
        doc.save("Weekly_Study_Timetable.pdf");
    });
}